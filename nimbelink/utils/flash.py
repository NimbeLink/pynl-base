"""
Provides handling of flash contents
...
class Flash:
    ...
    class Chunk:
        ...
        def __init__(self, start: int, data: typing.List[int]) -> None:
            """Creates a new chunk
    ...
    @staticmethod
    def paginateChunk(chunk: "Flash.Chunk") -> typing.List["Flash.Chunk"]:
    ...
    @staticmethod
    def getChunkSort(chunk: "Flash.Chunk") -> int:
    ...
    @staticmethod
    def sortChunks(chunks: "Flash.Chunk") -> None:
    ...
    @staticmethod
    def _waitReady(ahb: debugger.Ahb, ready: int) -> None:
    ...
    @staticmethod
    def erasePage(ahb: debugger.Ahb, start: int) -> None:
    ...
    @staticmethod
    def writePage(ahb: debugger.Ahb, start: int, data: typing.List[int]) -> None:
    ...
    def writeChunks(
        ahb: debugger.Ahb,
        chunks: typing.List["Flash.Chunk"],
        erase: bool = True,
        ...
        for chunk in pageChunks:
            ...
            if erase and (page != lastPage):
                logging.getLogger(__name__).info("Erasing page @ {:08X}".format(chunk.start))
            ...
            logging.getLogger(__name__).info("Writing {} to page @ {:08X}".format(len(chunk.data), chunk.start))
